                ...
                .then(literal("add")
                    .then(argument("id", StringArgumentType.word())
                        .then(argument("value", StringArgumentType.greedyString())
                            .executes(context -> {
                                boolean success = CustomEmojiManager.addEmoji(StringArgumentType.getString(context, "id"), StringArgumentType.getString(context, "value"));
        ...
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) -> {
            dispatcher.register(
                ...
                .then(literal("remove")
                    .then(argument("id", StringArgumentType.word())
                        .executes(context -> {
                            boolean success = CustomEmojiManager.removeEmoji(StringArgumentType.getString(context, "id"));
